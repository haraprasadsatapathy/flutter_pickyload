        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Google Map with gestureRecognizers ─────────────────
                    Expanded(
                      child: ClipRRect(
                        ...
                        child: GoogleMap(
                          ...
                          // Eagerly claim ALL gestures so the map gets
                          // scroll/zoom events instead of the parent ListView.
                          gestureRecognizers: {
              ...
              if (widget.trip.hasDriverDetails) const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.lock_outlined, color: iconColor),
